...
/* Why is this let revString = [] instead of let yourString = []??? 
    Answer on 05/08/24 We declare an empty array named revString to hold the values generated by each iteration of the for loop. */
...
function displayReversedString (revString) {
    ...
    //show the alert box which displays the alert message
